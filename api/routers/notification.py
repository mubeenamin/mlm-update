...
async def create_notification(db: db_dependency, user: user_dependency, notification: notification):
    db.add(notification)
    db.commit()
...
async def delete_notification_by_id(db: db_dependency, user: user_dependency, notification_id: int):
