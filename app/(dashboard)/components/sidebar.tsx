            ...
            <nav className="grid items-start px-2 text-sm font-semibold">
              {admin_data.map((value, i) => (
                <Link
                  href={value.href}
                  key={i}
                  className="flex items-center gap-3 hover:underline underline-offset-4 bg-black/5 px-6 py-3 text-gray-900  transition-all hover:text-gray-900 dark:bg-gray-800 dark:text-gray-50 dark:hover:text-gray-50"
                >
