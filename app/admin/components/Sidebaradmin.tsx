...
const Sidebaradmin = () => {
  ...
  return <div className="bg-white w-[300px] h-screen p-4 shrink-0">
    <div className="flex items-center gap-4">
        <Image src="/logo.jpeg" alt="logo" width={50} height={50} className="rounded-full"></Image>
